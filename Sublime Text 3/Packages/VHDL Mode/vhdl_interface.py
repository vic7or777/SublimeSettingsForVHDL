...
class vhdlModePasteAsTestbenchCommand(sublime_plugin.WindowCommand):
    ...
    def run(self):
        ...
        resetprocess_str = _interface.resetprocess()
        testdata_str = _interface.testdata()
        ...
        tb_view.run_command("insert_snippet",
            {
                ...
                "RESETPROCESS" : resetprocess_str,
                "TESTDATA" : testdata_str
            })
...
#----------------------------------------------------------------
#----------------------------------------------------------------
class vhdlModePasteAsProcess(sublime_plugin.TextCommand):
    def run(self, edit):
        # global _interface
        ...
        snippet_clk = "Packages/VHDL Mode/Snippets/proc_clk_func.sublime-snippet"
        in_port_str = _interface.in_port()
        out_port_str = _interface.out_port()
        ...
        print('vhdl-mode: Created SuperProcess.')
